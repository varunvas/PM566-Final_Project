...
### __By the numbers: Examine trends by state, year, and percent vaccination rate _change_ (from 2012 to 2020) by ordering and searching data.__
<br>
...
#### *Hawaii, Wyoming, and Maryland top the list of states with the largest increases in vaccination rates.
<br>
<br>
...
####  *Older women are more likely to be vaccinated against Influenza.
####  *This trend is consistent across the years. 
...
### __By the numbers: Examining vaccination nationally (table 2) and by state (table 3) for age and race/ethnicity subpopulations.__
