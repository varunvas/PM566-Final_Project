...
#### _*Overall, vaccination rates have increased between 2012-2020._
#### _*The Midwest and Northeast regions appear particularly increased._
...
### __A closer look at trends by REGION__ 
<br>
...
#### _*All U.S. regions had higher vaccination rates in 2020 than 2012._
#### _*The pattern has remained consistent, lowest rates in the South, highest rates in the Northeast._
###### _Note: Lines in each box are median values._ 
<br>

### __Delving deeper: individual STATE trends__ 
<br>
...
gall
```
###### _Note: Hover over each line for more data. Double click in Right hand panel to view states individually._
<br>
<br>

#### By the numbers: Examine trends by state, year, and percent vaccination rate _change_ (from 2012 to 2020) by ordering and searching data.
<br>

### Table 1. Change in Vaccination Rate by State, 2012 to 2020
...
#### _*Hawaii, Wyoming, and Maryland top the list of states with the largest increases in vaccination rates._
<br>
<br>

### __Additional Granularity: How do age and ethnicity affect Influenza vaccination uptake?__
<br>
...
####  _*Older women are more likely to be vaccinated against Influenza._
####  _*This trend is consistent across the years._ 
...
#### _*Women in the "other" race/ethnicity category have the highest vaccination rates as of 2020, overtaking White women in 2014._
#### _*Black women have the lowest rates of vaccination and since 2016 rates have been trending downward._ 

<br>
<br>

### By the numbers: Examining vaccination nationally (table 2) and by state (table 3) for age and race/ethnicity subpopulations.
...
###      *Nationwide, vaccination for influenza virus is increasing since 2012
<br>

###      *All regions of the U.S. show increasing vaccination rates, though the South continues with low rates (below 50%).
<br>
...
##### <img src="https://www.logo.wine/a/logo/GitHub/GitHub-Icon-White-Dark-Background-Logo.wine.svg" width="40px"> View project Github Repository [here](https://github.com/CBSC73/PM566-Final_Project)
