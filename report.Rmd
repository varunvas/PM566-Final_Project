...
```{r load-data, warning=FALSE, message=FALSE, cache=TRUE, include=FALSE}
...
```
```{r, compare vaccine rates by region over time, echo=FALSE, fig.height = 5, fig.width = 5, fig.align = "center"}
...
```{r, create interactive line graphs, echo=FALSE, fig.height = 5, fig.width = 5, fig.align = "center"}
...
```{r, table create, echo=FALSE, fig.height = 5, fig.width = 5, fig.align = "center"}
...
```{r, create interactive table of National Data, echo=FALSE, fig.height = 5, fig.width = 5, fig.align = "center"}
...
```{r, create interactive table of States Data, echo=FALSE, fig.height = 5, fig.width = 5, fig.align = "center"}
