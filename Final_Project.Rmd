...
ggplotly(agebar, tooltip="textage")
...
ggplotly(ethbar, tooltip="texteth")
...
table1<-vaxdfUS %>% select(Year, Dimension, Percent_Vax) 
colnames(table1)<- c("Year", "Age or Race/Ethnicity", "Vaccination Rate (%)")
knitr::kable(table1, align=c("c", "c", "c"), caption = "Table 1. Nationwide: Influenza Vaccination Rate Among Pregnant U.S. Women, 2012-2020")
datatable(table1)

```
```{r, create interactive table of States Data, echo=FALSE}

table2<-vaxdfSTATES %>% filter(!is.na(Percent_Vax)) %>% select(state,Year, Dimension, Percent_Vax)
colnames(table2)<- c("State", "Year", "Age or Race/Ethnicity", "Vaccination Rate (%)")
knitr::kable(table2, align=c("c", "c", "c", "c"), caption = "Table 2. By State: Influenza Vaccination Rate Among Pregnant U.S. Women, 2012-2020")
datatable(table2)
```
