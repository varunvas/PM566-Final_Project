...
#### Table with vaccination rate changes values
```{r}
...
knitr::kable(vaxchange, align=c("l", "c", "c", "c"), caption = "Table 1. Change in Vaccination Rate From 2012 to 2020 by State")
...
knitr::kable(table2, align=c("c", "c", "c"), caption = "Table 2. Nationwide: Influenza Vaccination Rate Among Pregnant U.S. Women, 2012-2020")
datatable(table2)
...
knitr::kable(table3, align=c("c", "c", "c", "c"), caption = "Table 3. By State: Influenza Vaccination Rate Among Pregnant U.S. Women, 2012-2020")
datatable(table3)
```
